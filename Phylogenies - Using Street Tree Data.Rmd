...
```{r}
fn <- read.csv("https://data.cityofnewyork.us/api/views/5rq2-4hqu/rows.csv?accessType=DOWNLOAD
", header=TRUE)
...
In the past, I've taught Phylomatic, but nowthere are more recent options, most recently one that includes not just angiosperms and gymnosperms (G.Phylomaker, it use the zanne2014 tree) but also many ferns and other seedless vascular plants. 
