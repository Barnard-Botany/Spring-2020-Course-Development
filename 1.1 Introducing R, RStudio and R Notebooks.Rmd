...
This Notebook should be read and used before "Introduction to getting, testing and plotting data." 

Definitely follow your work with this Notebook by opening and doing that companion lesson. 
...
2. Press the Insert button in the menu above this window, then copy/paste (or re-type or write) your code in the middle of the blank chunk that's been opened. Run the chunk by pressing the plan button in the upper right corner of the chunk.
...
A follow up lesson will demonstrate data downloading, more summary statistics, simple statistical tests and statistical models, and some plotting of data (see "1.2 Introducing getting, testing and plotting data").
>>>>>>> 0c08212ab862ab7a9a554db7f4fd9fcdb48449aa
